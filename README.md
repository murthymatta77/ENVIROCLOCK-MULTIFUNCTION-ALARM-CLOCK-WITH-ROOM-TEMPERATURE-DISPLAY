...
Switches, 
Features: 
Real-Time Clock Display shows hour,minute,second,day,date,month,year on a16x2 lcd.
Temperature Display: 
...
3:EXIT Alarm 
Functinality: 
user enter alarm hour and minute,compare with RTC registers ifequal Buzzer ON and alarm Symbol ON on LCD Alarm runs for 1 minute or can be stopped manually with a switch
